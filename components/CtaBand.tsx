...
export default function CtaBand({
  ...
  return (
    <Section>
      <Wrap>
        <div className="relative grid gap-6 overflow-hidden rounded-[30px] border border-gold/30 p-8 shadow-deep sm:p-12 lg:grid-cols-[1.3fr_1fr] lg:items-center lg:gap-8 bg-[radial-gradient(520px_280px_at_88%_6%,rgba(192,145,47,.28),transparent_64%),radial-gradient(460px_320px_at_4%_96%,rgba(58,99,216,.45),transparent_66%),linear-gradient(140deg,#1e40af,#0a1738)]">
          <div>
            <h2 className="max-w-[18ch] font-serif text-[clamp(1.6rem,5vw,2.5rem)] leading-tight text-white">
              {title}
            </h2>
            <p className="mt-3 font-tamil text-gold-light">
