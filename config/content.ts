...
/** The same mark lifted in brightness for the dark nav disc, where the
 *  peacock's deep green would otherwise sink into the ground. */
export const logoNavLight = `${BASE_PATH}/img/logo-nav-light.png`;
